...
{
    public void Construct(NodeGraphInitializer nodeGraphInitializer, SeriaGameStatsProviderEditor seriaGameStatsProviderEditor, SwitchToNextSeriaEvent<bool> switchToNextSeriaEvent,
        int currentSeriaIndex = 0, int currentNodeGraphIndex = 0, int currentNodeIndex = 0)
    {
        ...
        GameStatsProvider = seriaGameStatsProviderEditor;
