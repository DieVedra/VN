...
{
    [SerializeField, Expandable] private SpriteData _test;
    [SerializeField, Expandable] private LevelPartNodeGraph _test1;
    ...
    [SerializeField] private NodeGraphsHandler _nodeGraphsHandler;
    ...
    [SerializeField] private GameStatsCustodian _gameStatsCustodian;
    ...
    [SerializeField] private bool _loadSaveData;
    ...
    public void Init()
    {
        // LocalizableString[] localizableStrings = FindObjectsOfType<LocalizableString>(true);
        
        
        if (_loadSaveData == true && _gameMode == GameMode.BuildMode)
        {
    ...
    private void InitWardrobeCharacterViewer(ViewerCreator viewerCreatorEditMode)
    {
