...
public class ContactsScreenHandler : PhoneScreenBaseHandler, ILocalizable
{
    ...
    public ContactsScreenHandler(ContactsScreenView contactsScreenViewBackground, TopPanelHandler topPanelHandler, ReactiveCommand<PhoneBackgroundScreen> switchPanelCommand)
        :base(contactsScreenViewBackground.gameObject, topPanelHandler, contactsScreenViewBackground.ImageBackground, switchPanelCommand, contactsScreenViewBackground.ColorTopPanel)
    {
