...
namespace UniRx
{
    ...
    /// </summary>
    public class ReactiveCommand : ReactiveCommand<Unit>, IReactiveCommandExecuteOnly
    {
        /// <summary>
    ...
    public class ReactiveCommand<T> : IReactiveCommand<T>, IReactiveCommandExecuteOnly<T>, IReactiveCommandSubscribeOnly<T>, IDisposable
    {
    ...
    public interface IReactiveCommandExecuteOnly<T>
    {
        bool Execute(T parameter);
    }
    public interface IReactiveCommandSubscribeOnly<T>
    {
        IDisposable Subscribe(IObserver<T> observer);
    }
    // public interface IReactiveCommandSubscribeOnly
    // {
    //     IDisposable Subscribe(IObserver observer);
    // }
    public interface IReactiveCommandExecuteOnly
    {
        bool Execute();
    }
    /// <summary>
